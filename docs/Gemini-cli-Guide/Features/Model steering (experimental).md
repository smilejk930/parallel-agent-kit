...
source: "https://geminicli.com/docs/cli/model-steering/"
author:
...
Model steering is particularly useful during complex [Plan Mode](https://geminicli.com/docs/cli/plan-mode) workflows or long-running subagent executions where you want to ensure the agent stays on the right track.
