...
1. **VS Code companion extension**: Install the “Gemini CLI Companion” extension on [Antigravity](https://antigravity.google/), [Visual Studio Code](https://code.visualstudio.com/), or other VS Code compatible editors.
2. **Agent Client Protocol (ACP)**: An open protocol for interoperability between AI coding agents and IDEs. This method is used for integrations with tools like JetBrains and Zed, which leverage the ACP Agent Registry for easy discovery and installation of compatible agents like Gemini CLI.
...
For a comprehensive introduction to ACP, including its architecture and benefits, refer to the official [ACP Introduction](https://agentclientprotocol.com/get-started/introduction) documentation.
...
For more details on how the registry works, visit the official [ACP Agent Registry](https://agentclientprotocol.com/get-started/registry) page. You can learn about how specific IDEs leverage this integration in the following section.
...
For more details, refer to the official [JetBrains AI Blog announcement](https://blog.jetbrains.com/ai/2026/01/acp-agent-registry/).
...
Learn more about Zed’s integration with the ACP Registry in their [blog post](https://zed.dev/blog/acp-registry).
...
For issues related to ACP integration, refer to the debugging and telemetry section in the [ACP Mode](https://geminicli.com/docs/cli/acp-mode) documentation.