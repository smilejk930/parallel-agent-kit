...
source: "https://geminicli.com/docs/cli/notifications/"
author:
...
Notifications are particularly useful when running long-running tasks or using [Plan Mode](https://geminicli.com/docs/cli/plan-mode), letting you switch to other windows while Gemini CLI works in the background.
