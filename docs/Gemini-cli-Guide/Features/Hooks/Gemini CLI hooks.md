...
- **[Writing hooks guide](https://geminicli.com/docs/hooks/writing-hooks)**: A tutorial on creating your first hook with comprehensive examples.
- **[Best practices](https://geminicli.com/docs/hooks/best-practices)**: Guidelines on security, performance, and debugging.
- **[Hooks reference](https://geminicli.com/docs/hooks/reference)**: The definitive technical specification of I/O schemas and exit codes.
...
See [Security Considerations](https://geminicli.com/docs/hooks/best-practices#using-hooks-securely) for a detailed threat model.
