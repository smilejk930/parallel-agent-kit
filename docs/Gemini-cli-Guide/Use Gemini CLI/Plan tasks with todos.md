---
title: "Plan tasks with todos"
source: "https://geminicli.com/docs/cli/tutorials/task-planning/"
author:
...
- **Current focus:** The active task is highlighted (for example, `[IN_PROGRESS] Create tsconfig.json`).
...
- Explore [Session management](https://geminicli.com/docs/cli/tutorials/session-management) to save your plan and finish it tomorrow.
- See the [Todo tool reference](https://geminicli.com/docs/tools/todos) for technical schema details.
- Learn about [Memory management](https://geminicli.com/docs/cli/tutorials/memory-management) to persist planning preferences (for example, “Always create a test plan first”).