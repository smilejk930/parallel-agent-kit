...
source: "https://geminicli.com/docs/cli/tutorials/plan-mode-steering/"
author:
...
[Plan Mode](https://geminicli.com/docs/cli/plan-mode) typically follows a linear path: research, propose, and draft. Adding model steering lets you:
...
- Explore [Agent Skills](https://geminicli.com/docs/cli/skills) to add specialized expertise to your planning turns.
- See the [Model steering reference](https://geminicli.com/docs/cli/model-steering) for technical details.