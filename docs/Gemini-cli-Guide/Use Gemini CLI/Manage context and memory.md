...
Gemini CLI is powerful but general. It doesn’t know your preferred testing framework, your indentation style, or your preference against `any` in TypeScript. Context management solves this by giving the agent persistent memory.
...
- Learn about [Session management](https://geminicli.com/docs/cli/tutorials/session-management) to see how short-term history works.
- Explore the [Command reference](https://geminicli.com/docs/reference/commands) for more `/memory` options.
- Read the technical spec for [Project context](https://geminicli.com/docs/cli/gemini-md).
- Try the experimental [Auto Memory](https://geminicli.com/docs/cli/auto-memory) feature to extract reusable skills from your past sessions automatically.