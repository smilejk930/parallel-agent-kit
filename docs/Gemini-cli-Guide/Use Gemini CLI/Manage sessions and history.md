...
source: "https://geminicli.com/docs/cli/tutorials/session-management/"
author:
...
4. Later, use `/resume resume decision-point` to fork the conversation back to that moment and try a different approach.

This creates a new branch of history without losing your original work.

## Next steps

- Learn about [Checkpointing](https://geminicli.com/docs/cli/checkpointing) to understand the underlying safety mechanism.
- Explore [Task planning](https://geminicli.com/docs/cli/tutorials/task-planning) to keep complex sessions organized.
- See the [Command reference](https://geminicli.com/docs/reference/commands) for `/resume` options, grouped checkpoint menus, and `/chat` compatibility aliases.