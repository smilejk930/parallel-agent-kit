...
**User:** “Can you audit [http://geminicli.com](http://geminicli.com/) ”
...
- Explore the [Agent Skills Authoring Guide](https://geminicli.com/docs/cli/skills#creating-a-skill) to learn about more advanced features.
- Learn how to share skills via [Extensions](https://geminicli.com/docs/extensions).